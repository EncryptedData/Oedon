...
//   You may decide to setup the platform_io's *RenderWindow and *EndFrame pointers and call your functions through those pointers,
...
struct ImGuiPlatformIO
{
    ...
    void    (*Platform_SwapBuffers)(ImGuiViewport* vp, void* render_arg);   // . . . R .  // (Optional) Call Present/EndFrame (platform side! This is often unused!). 'render_arg' is the value passed to RenderPlatformWindowsDefault().
    ...
    void    (*Renderer_SwapBuffers)(ImGuiViewport* vp, void* render_arg);   // . . . R .  // (Optional) Call Present/EndFrame. 'render_arg' is the value passed to RenderPlatformWindowsDefault().
